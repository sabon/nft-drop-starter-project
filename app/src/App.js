...
const App = () => {
  ...
  // Render this UI when the wallet hasn't connected to the app yet
  ...
  // When the component first mounts, check to see if there's a connected Phantom Wallet
  useEffect(() => {
    const onLoad = async () => {
